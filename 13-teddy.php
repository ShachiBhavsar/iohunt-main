   ...
   if (distance < 0) {
    ...
    <body>
        ...
        <div class="container">
            ...
            Who doesn't have an account on the world's largest search engine's inbox! Check it now! The way to the next question lies within...<br>
Hint 1: What do alarms face everytime they speak?<br>
Hint 2: What's common between the question and hint 1? 
        </div>
...
<!-- Hint: Just an action. Nothing more. Remember, it's the present.-->