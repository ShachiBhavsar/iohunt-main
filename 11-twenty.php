   ...
   if (distance < 0) {
    ...
    <body>
        ...
        <div class="container">
            ...
            The part of academic experience without which you couldn’t get where you are! But until this year!!! Guess the menace? :p
...
<!-- Hint: But wait, Is that really the clue to next question? NO! The way to next question is firsts of the states mentioned where you are looking for answer!!!-->
