   ...
   if (distance < 0) {
    ...
    <body>
        ...
        <div class="container">
            ...
            Carve the answer to this question in your hand and proceed:
            <br>
            The answer lies in the deepest of oceans, where, when you try to find out a way through the labyrinth, in the end you lose your way forever.
        </div>
        <br>
...
<!-- Hint: You know this trend from recent months.-->