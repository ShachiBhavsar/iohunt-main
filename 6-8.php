   ...
   if (distance < 0) {
    ...
    <body>
        ...
        <div class="container">
            ...
            I remember cool dancing pink lion from boombahgarh with booming roar from the days of my childhood.<br>
            His small cute friend with orange hair and almond eyes will lead you to where you want to be.<br>
            Find her or be my puppet and I'll tell you the answer.
        </div>
        <br>
