   ...
   if (distance < 0) {
    ...
    <body>
        ...
        <div class="container">
            ...
            The boring CEO bagged a contract with the world’s largest space research organisation owing to the one and only bird. The class of the bird will guide you to the next level.
        </div>
        <br>
...
<!-- Hint: You sure are looking for the classification of bird!-->