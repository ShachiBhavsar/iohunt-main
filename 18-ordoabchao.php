   ...
   if (distance < 0) {
    ...
    <body>
        ...
        <div class="container">
            ...
            Caesar’s Prank<br>
            wtlstieyoarehavyrniucdhircoeefreiasphucxynonvpuawttoafteazwieoumlhbrzaldnteaeutlyltyisliietboopntilcjhetnepwntunadhlylok.
            <br>
            Hint: Keep the prank in the box!
