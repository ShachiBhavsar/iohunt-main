   ...
   if (distance < 0) {
    ...
    <body>
        ...
        <div class="container">
            ...
            To get to the next level you just need to take out time and solve the below question:<br>

"supposesomewatchmonstersaretimechasingsundialyouandyouarerunningatclockthefastestspeedtimerpossible.<br>doyouthinkstopwatchyoucanescape?"
...
<!-- Hint1: What? I was literally talking about taking time out! -->
<!-- Hint2: Be positve. -->