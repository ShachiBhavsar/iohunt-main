...
var x = setInterval(function() {
   ...
   if (distance < 0) {
    ...
    <body>
        ...
        <br>
        <div class="container">
            <font color="black" size="5.5" face="Courier new"/>
            <div class="jumbotron text-center" id="high">
            <div id="demo" align="right" style="font-size: 20px;">
           ...
           <center><iframe align="middle" width="620" height="240" src="Gandhinagar_TV_Video.mp4" >
        </iframe></center>
        </div><br>
        <div class="container" id="footer">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <img src="sharkid.png" alt="Sharkid" style="width: 175px; padding-left: 20%" id="sharkid">
                </div>
                <div class="col-md-4">
...
<!-- Hint: India's premier training institute.
Relate above hint and the video....counting the centers where you can find this institute will take you to your answer.-->
