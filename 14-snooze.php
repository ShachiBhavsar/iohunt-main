   ...
   if (distance < 0) {
    ...
    <body>
        ...
        <div class="container">
            ...
            "And then they lived happily ever after"<br>You may have a happy ending too, if you are able to give the answer to this question. Having doubts? Ask the mirror... The answer lies in its answer...
        </div>
        <br>
...
<!-- Hint: count your blessings that not everything is white as snow-->