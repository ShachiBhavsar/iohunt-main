   ...
   if (distance < 0) {
    ...
    <body>
        ...
        <div class="container">
            ...
            Shake your legs and feel out of the world..moonwalk your way towards the answer and tell us the name of the first collection ,which marked the reign of the King of pop.
        </div>
        <br>
