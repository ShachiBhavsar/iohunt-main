   ...
   if (distance < 0) {
    ...
    <body>
        ...
        <div class="container">
            ...
            Telecom industry changed after its entry and the next question opens if you answer the number of contents it offers to you...
        </div>
        <br>
...
<!-- Hint: Answer to the question itself contains life in it.-->